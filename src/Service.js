...
export default class Service {
     ...
     * @return self for easy chaining (`Service.option().option()`).
     */
    option(option = {}) {
    ...
    /**
     * Getter for a specific group of paths (i.e., "a menu").
     *
     * @param string id Usually taken from the <monad-navigation menu="id">
     *  attribute.
     */
    getPath(id) {
        return paths[id] || [];
